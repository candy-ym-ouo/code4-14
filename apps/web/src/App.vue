...
import { Box, Collection, Coin, DataAnalysis, Document, FolderOpened, Location, Setting, Tickets } from "@element-plus/icons-vue";
...
const activeMenu = computed(() => {
  ...
  if (route.path.startsWith("/costing")) return "/costing";
  ...
  <el-container v-else class="app-shell">
    <el-aside width="232px" class="sidebar">
      ...
      <el-menu :default-active="activeMenu" router class="side-menu">
        ...
        <el-menu-item index="/costing"><el-icon><Coin /></el-icon><span>成本核算</span></el-menu-item>
